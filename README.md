...
| [**Helix**](https://github.com/tomarai85/helix-releases) | Shipped macOS app, free beta. Four terminal panes plus a live browser preview in one window — built for running Claude Code, an SSH session, and a dev server side by side. This repo is the release channel, not the source. |
